                ...
                <Grid>
                  <Grid.Col span={6}>
                    <TextInput
                      ...
                      styles={{ label: { color: TEXT_SEC }, input: { backgroundColor: 'var(--mantine-color-default)', borderColor: SURFACE_BORDER, color: 'var(--mantine-color-text)' } }}
                    />
                  </Grid.Col>
                  <Grid.Col span={6}>
                    <TextInput
            ...
            >
              <Stack gap="md">
                <Select
                  ...
                  styles={{ label: { color: TEXT_SEC }, input: { backgroundColor: 'var(--mantine-color-default-hover)', borderColor: SURFACE_BORDER, color: 'var(--mantine-color-text)' } }}
                />
                <Textarea
                  label="Описание"
